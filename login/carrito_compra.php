	...
	if ($_GET["action"] == "delete") {
		foreach ($_SESSION["shopping_cart"] as $keys => $values) {
			if ($values["item_id"] == $_GET["id"]) {
				...
				echo '<script>window.location="carrito_compra.php"</script>';
			}
		}
	}
}
...
<body style="background:#f0f0f0;">
	...
	<div class="container">
		...
		<br />
		<br />
		<h3 align="center"><a href="https://www.configuroweb.com/" title="Para más desarrollos ConfiguroWeb" style="color:black;text-decoration:none;">Para más desarrollos ConfiguroWeb</a></h3><br />
		<br /><br />
		<?php
		...
		?>
				<div class="col-md-4">
					<form method="post" action="carrito_compra.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<table class="table table-bordered">
				...
				?>
						<tr>
							...
							<td style="color:black"><a href="carrito_compra.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Quitar Producto</span></a></td>
						</tr>
					<?php
